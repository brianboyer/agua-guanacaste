...
PROJECT_NAME = 'agua-guanacaste'

# Project name in urls
# Use dashes, not underscores!
PROJECT_SLUG = 'agua-guanacaste'

# The name of the repository containing the source
REPOSITORY_NAME = 'agua-guanacaste'
REPOSITORY_URL = 'git@github.com:nprapps/%s.git' % REPOSITORY_NAME
REPOSITORY_ALT_URL = None # 'git@bitbucket.org:nprapps/%s.git' % REPOSITORY_NAME'

# The name to be used in paths on the server
PROJECT_FILENAME = 'agua_guanacaste'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '0AkS3wCBaGOEydDI4cFJWRzV6X1V1SkNlTGh3UWVGUnc'
